...
const ViewCourseMaterialsAdmin = () => {
  ...
  const fetchCourseMaterials = async () => {
    try {
      ...
      const response = await fetch('http://localhost:5000/api/lectures/get_course_materials_admin', {
        method: 'POST',
        headers: {
...
export default ViewCourseMaterialsAdmin;
